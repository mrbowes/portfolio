  ...
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        ...
        <SVG icon="triangle" width={8} stroke={colors['carolina-blue']} left="25%" top="5%" />
        <SVG icon="circle" hiddenMobile width={24} fill={colors.white} left="17%" top="60%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16} fill={colors.teal} left="20%" top="90%" />
        ...
        <SVG icon="upDown" hiddenMobile width={8} fill={colors.grey} left="45%" top="10%" />
      </UpDownWide>
      <SVG icon="circle" width={6} fill={colors.purple} left="4%" top="20%" />
      <SVG icon="circle" width={12} fill={colors.teal} left="40%" top="60%" />
      <SVG icon="box" width={6} fill={colors['caroline-blue']} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors.yellow} left="49%" top="26%" />
